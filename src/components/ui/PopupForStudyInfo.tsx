...
export default function PopupForStudyInfo() {
  return (
    <div
      ...
      className="w-11/12 sm:w-10/12 lg:w-8/12 py-10 rounded-2xl shadow-xl shadow-[#313131] h-fit bg-white  mx-auto flex flex-col items-start gap-6 px-2 sm:px-5  text-[12px] sm:text-[14px] text-center lg:text-[16px] text-[#344054]"
    >
      <div className=" w-20 border-t mx-auto border-[#484242] pb-5 "></div>
      <p className=" w-full">
      ...
      <div className=" w-20 border-b mx-auto border-[#484242] pb-5   "></div>
    </div>
  );
}
